...
||");
		...
		catch (AggregateException ex)
		{
			...
			Assert.That(ex.InnerExceptions[0].Message, Is.EqualTo("$: line 2"));
			Assert.That(ex.InnerExceptions[1].Message, Is.EqualTo("#: line 3"));
			Assert.That(ex.InnerExceptions[2].Message, Is.EqualTo("&: line 4"));
			Assert.That(ex.InnerExceptions[3].Message, Is.EqualTo("|: line 5"));
		}
	}
}